...
window.onload = async function() {
    document.getElementById('user_contact_update').disabled = true;
    ...
    fetch('/account/pwcheck', {
        ...
        .then(data => {
            if (data.success) {
                ...
                document.getElementById('user_contact_update').disabled = false;
...
async function handleUserContactUpdate(event) {
    event.preventDefault(); // Prevent default form submission
    ...
    const user_contact_upd = document.getElementById('user_contact_update').value;
    if (!user_contact_upd.trim()) {
    ...
    .then(data => {
        if (data.success) {
            ...
            document.getElementById('user_contact_update').value = '';
